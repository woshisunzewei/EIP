...
function initGird() {
    $grid = $("#list").jgridview(
    {
        ...
        colModel: [
            ...
            { label: "标题", name: "Code", width: 150, fixed: true },
            { label: "编号", name: "Name", width: 150, fixed: true },
            { label: "当前状况", name: "Version", width: 60, fixed: true },
            { label: "当前节点", name: "IsFreeze", formatter: "YesOrNo", width: 50, align: "center", fixed: true },
            { label: "紧急状况", name: "CreateTime", width: 120, fixed: true },
            { label: "创建日期", name: "CreateTime", width: 120, fixed: true },
            { label: "归属流程", name: "CreateTime", width: 120, fixed: true }
        ],
