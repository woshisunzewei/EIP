...
function initGird() {
    $grid = $("#list").jgridview(
    {
        url: "/Workflow/HaveDo/GetWorkflowEngineHaveDoTaskOutput",
        loadonce:false,
        shrinkToFit: true,
        multiselect: false,
        colModel: [
            ...
            { name: "UrgencyFormatter", hidden: true },
            ...
            { label: "我经办的步骤", name: "DoCurrentActivityName", width: 150, fixed: true },
            { label: "流程状态", name: "StatusFormatter", width: 50, fixed: true },
            { label: "当前节点", name: "CurrentActivityName", width: 150, fixed: true },
            { label: "未处理人", name: "ReceiveUserName", width: 60, fixed: true },
            { label: "创建人", name: "SendUserName", width: 60, fixed: true },
            { label: "创建时间", name: "SendTime", align: "center", fixed: true }
        ],
        sortname: "a.ProcessInstanceId",
