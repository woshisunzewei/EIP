...
<body>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="95%" class="formtable">
        <tr>
            <th>默认值：</th>
            <td>
                <input type="text" class="mytext" id="defaultvalue" style="width: 250px; margin-right: 6px;" />
                <select class="myselect" onchange="setDefaultValue(document.getElementById('defaultvalue'), this.value);" style="width: 100px">
        ...
        <tr>
            <th>字号：</th>
            <td>
                <input type="text" id="fontsize" class="mytext" style="width: 150px" />
                (例:18px, 18pt)</td>
        </tr>
        <tr>
            <th>颜色：</th>
            <td>
                <input type="text" id="fontcolor" class="mytext" style="width: 150px" />
                (例:#cccccc, red)</td>
        </tr>
        <tr>
            <th>样式：</th>
            <td>
                <input type="checkbox" id="fontbold" value="1" style="vertical-align: middle;" /><label for="fontbold" style="vertical-align: middle;">粗体</label>
