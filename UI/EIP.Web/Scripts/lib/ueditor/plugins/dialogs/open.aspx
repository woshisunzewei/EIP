...
<form method="post">
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
           ...
           <%-- roadTree = new RoadUI.Tree({ id: "TypeDiv", path: top.rootdir + "/Platform/Dictionary/Tree1.ashx?ischild=1&root=<%=rootid%>", refreshpath: top.rootdir + "/Platform/Dictionary/TreeRefresh.ashx", onclick: openUrl });
            openUrl({ id: "<%=rootid%>" });--%>
        });
