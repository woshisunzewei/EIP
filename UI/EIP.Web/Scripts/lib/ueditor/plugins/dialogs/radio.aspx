...
<head id="Head1" runat="server">
    ...
    <link href="../../../../lib/artdialog/skins/chrome.css" rel="stylesheet" />
    <script src="../../../../lib/artdialog/artDialog.source.js"></script>
    <script src="../../../../lib/artdialog/plugins/iframeTools.source.js"></script>
</head>
<body>
            ...
            <div id="text_attr" class="panel focus">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    ...
                    <tr>
                        <th>数据源：</th>
                        <td>
                            <%=FormControl.GetDataSourceRadios("datasource","0","onclick='dsChange(this.value);'") %>
                        </td>
                    </tr>
                    <tr id="ds_dict">
                        <th>字典项：</th>
                        <td>
                            <input type="text" class="mydict" id="ds_dict_value" more="0" value="" readonly="readonly"/>
                            <input id="ds_dict_value_hidden" name="ds_dict_value_hidden" type="hidden" />
                            <input id="ds_dict_chosen" type="button" class="button_search" plugin="dictionary-all" value="选择" />
                        </td>
                    </tr>
                </table>
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding-top: 4px;">
                                            ...
                                            <div style="margin-top: 5px;">
                                                <textarea cols="1" rows="1" id="ds_sql_value" style="width: 99%; height: 95px; font-family: Verdana;" class="mytextarea">                                                    
                                                </textarea>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <script type="text/javascript">
        ...
        function initChosenDic() {
            ArtDialogOpen("/Common/UserControl/ChosenDictionaryAll?id=" + $("#DictionaryId").val(), "请选择字典", true, 350, 300);
        }

        //重新赋予字典
        function setDic() {
            var edit = UtilGetUrlParam("id");
            if (art.dialog.data('dicObj').length === 0) {
                $("#ParentName").val("");
            ...
            var dicObj = art.dialog.data('dicObj')[0];
