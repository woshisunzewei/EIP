        ...
        <tr>
            ...
            <td>
                <select class="myselect" id="editmode" style="width: 227px" onchange="editmode_change(this.value);">
                    <%=FormControl.GetEditmodeOptions("") %>
                </select></td>
        </tr>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        ...
                        <td>
                            <input type="text" class="mytext" id="text_defaultvalue" style="width: 250px; margin-right: 6px;" /><select class="myselect" onchange="setDefaultValue(document.getElementById('text_defaultvalue'), this.value);" style="width: 100px">
                    ...
                    <tr>
                        <th>值类型：</th>
                        <td>
                            <select class="myselect" id="text_valuetype">
                    ...
                    <tr>
                        <th>最大字符数：</th>
                        <td>
                            <input type="text" id="text_maxlength" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>宽度：</th>
                        <td>
                            <input type="text" id="text_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        <th style="width: 100px;">默认值：</th>
                        <td>
                            <input type="text" class="mytext" id="textarea_defaultvalue" style="width: 250px; margin-right: 6px;" /><select class="myselect" onchange="setDefaultValue(document.getElementById('textarea_defaultvalue'), this.value);" style="width: 100px">
                                <%=FormControl.GetDefaultValueSelectByAspx("") %>
                            </select></td>
                    </tr>
                    <tr>
                        <th>值类型：</th>
                        <td>
                            <select class="myselect" id="textarea_valuetype">
                                <%=FormControl.GetValueTypeOptions("") %>
                            </select></td>
                    </tr>
                    <tr>
                        <th>最大字符数：</th>
                        <td>
                            <input type="text" id="textarea_maxlength" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>宽度：</th>
                        <td>
                            <input type="text" id="textarea_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>高度：</th>
                        <td>
                            <input type="text" id="textarea_height" class="mytext" style="width: 150px" /></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <div id="tabdiv_select" style="width: 100%;">
                    <div id="select_base" style="padding-bottom: 8px; padding-top: 8px;" title="&nbsp;&nbsp;属性&nbsp;&nbsp;">
                        <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin: 0 auto;">
                            ...
                            <tr>
                                <th>
                                    <input type="radio" value="select_dsdict" name="select_ds" style="vertical-align: middle;" id="select_ds1" /><label style="vertical-align: middle;" for="select_ds1">数据源(字典):</label></th>
                                <td>
                                    <input type="text" class="mydict" id="select_ds_dict" more="0" value="" style="width: 200px;" /></td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="select_dssql" name="select_ds" style="vertical-align: middle;" id="select_ds2" /><label style="vertical-align: middle;" for="select_ds2">数据源(SQL):</label></th>
                                <td>
                                    <div>
                                        数据连接：<select class="myselect" id="select_ds_dbconn">
                                            <%--<%=dbconnOptions %>--%>
                                        </select>
                                    </div>
                                    <div style="margin-top: 3px;">
                                        <textarea cols="1" rows="1" class="mytextarea" id="select_ds_sql" style="width: 99%; height: 60px;"></textarea></div>
                                    <div style="margin: 3px 0;">格式：SELECT 值字段,标题字段 FROM 表名 WHERE 条件</div>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="select_dsstring" name="select_ds" style="vertical-align: middle;" id="select_ds3" /><label style="vertical-align: middle;" for="select_ds3">数据源(表达式):</label></th>
                                <td>
                                    <div>
                                        <textarea cols="1" rows="1" class="mytextarea" id="select_ds_string" style="width: 99%; height: 50px;"></textarea></div>
                                    <div>
                        ...
                        <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin: 0 auto;">
                            <tr>
                                <th style="width: 110px;">
                                    <input type="radio" value="checkbox_dsdict" name="checkbox_ds" style="vertical-align: middle;" id="checkbox_ds1" /><label style="vertical-align: middle;" for="checkbox_ds1">数据源(字典):</label></th>
                                <td>
                                    <input type="text" class="mydict" id="checkbox_ds_dict" more="0" value="" style="width: 200px;" /></td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="checkbox_dssql" name="checkbox_ds" style="vertical-align: middle;" id="checkbox_ds2" /><label style="vertical-align: middle;" for="checkbox_ds2">数据源(SQL):</label></th>
                                <td>
                                    <div>
                                        数据连接：<select class="myselect" id="checkbox_ds_dbconn">
                                            <%--<%=dbconnOptions %>--%>
                                        </select>
                                    </div>
                                    <div style="margin-top: 3px;">
                                        <textarea cols="1" rows="1" class="mytextarea" id="checkbox_ds_sql" style="width: 99%; height: 60px;"></textarea></div>
                                    <div style="margin: 3px 0;">格式：SELECT 值字段,标题字段 FROM 表名 WHERE 条件</div>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="checkbox_dsstring" name="checkbox_ds" style="vertical-align: middle;" id="checkbox_ds3" /><label style="vertical-align: middle;" for="checkbox_ds3">数据源(表达式):</label></th>
                                <td>
                                    <div>
                                        <textarea cols="1" rows="1" class="mytextarea" id="checkbox_ds_string" style="width: 99%; height: 50px;"></textarea></div>
                                    <div>
                                        <div style="margin: 3px 0;">格式：值0,标题0;值1,标题1</div>
                                        <div>示例：0,事假;1,病假;2,年假;3,婚假</div>
                                    </div>
                ...
                <div id="tabdiv_radio" style="width: 100%;">
                    <div id="radio_base" style="padding-bottom: 8px; padding-top: 8px;" title="&nbsp;&nbsp;属性&nbsp;&nbsp;">
                        <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin: 0 auto;">
                            <tr>
                                <th style="width: 110px;">
                                    <input type="radio" value="radio_dsdict" name="radio_ds" style="vertical-align: middle;" id="radio_ds1" /><label style="vertical-align: middle;" for="radio_ds1">数据源(字典):</label></th>
                                <td>
                                    <input type="text" class="mydict" id="radio_ds_dict" more="0" value="" style="width: 200px;" /></td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="radio_dssql" name="radio_ds" style="vertical-align: middle;" id="radio_ds2" /><label style="vertical-align: middle;" for="radio_ds2">数据源(SQL):</label></th>
                                <td>
                                    <div>
                                        数据连接：<select class="myselect" id="radio_ds_dbconn">
                                            <%--<%=dbconnOptions %>--%>
                                        </select>
                                    </div>
                                    <div style="margin-top: 3px;">
                                        <textarea cols="1" rows="1" class="mytextarea" id="radio_ds_sql" style="width: 99%; height: 60px;"></textarea></div>
                                    <div style="margin: 3px 0;">格式：SELECT 值字段,标题字段 FROM 表名 WHERE 条件</div>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <input type="radio" value="radio_dsstring" name="radio_ds" style="vertical-align: middle;" id="radio_ds3" /><label style="vertical-align: middle;" for="radio_ds3">数据源(表达式):</label></th>
                                <td>
                                    <div>
                                        <textarea cols="1" rows="1" class="mytextarea" id="radio_ds_string" style="width: 99%; height: 50px;"></textarea></div>
                                    <div>
                                        <div style="margin: 3px 0;">格式：值0,标题0;值1,标题1</div>
                                        <div>示例：0,事假;1,病假;2,年假;3,婚假</div>
                                    </div>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        <th style="width: 100px;">默认值：</th>
                        <td>
                            <input type="text" class="mytext" id="datetime_defaultvalue" style="width: 250px; margin-right: 6px;" /><select class="myselect" onchange="setDefaultValue(document.getElementById('datetime_defaultvalue'), this.value);" style="width: 100px">
                                <%=FormControl.GetDefaultValueSelectByAspx("") %>
                            </select></td>
                    </tr>
                    ...
                    <tr>
                        <th>宽度：</th>
                        <td>
                            <input type="text" id="datetime_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>选择范围：</th>
                        <td>
                    ...
                    <tr>
                        <th>是否选时间：</th>
                        <td>
                            <input type="checkbox" id="datetime_istime" value="1" style="vertical-align: middle;" /><label for="datetime_istime" style="vertical-align: middle;">是否允许选择时间</label></td>
                    </tr>
                    <tr>
                        <th>格式：</th>
                        <td>
                            <input type="text" id="datetime_format" class="mytext" style="width: 180px" /></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        <th style="width: 100px;">默认值：</th>
                        <td>
                            <select class="myselect" id="org_defaultvalue" style="width: 227px">
                                <%--<%=defaultOptions %>--%>
                            </select></td>
                    </tr>
                    <tr>
                        <th>宽度：</th>
                        <td>
                            <input type="text" id="org_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>选择范围：</th>
                        <td>
                            <div>
                                <%=FormControl.GetOrgRangeRadios("org_rang","") %>
                    ...
                    <tr>
                        <th>选择类型：</th>
                        <td>
                            <%=FormControl.GetOrgSelectTypeCheckboxs("org_type","") %>
                    ...
                    <tr>
                        <th>多选：</th>
                        <td>
                            <input type="checkbox" value="1" id="org_more" style="vertical-align: middle;" /><label for="org_more" style="vertical-align: middle;">是否可以多选</label></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="dict_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>选择范围：</th>
                        <td>
                            <div style="padding-top: 5px;">
                                <input type="text" id="dict_rang" class="mydict" style="width: 200px;" /></div>
                        </td>
                    </tr>
                    <tr>
                        <th>是否多选：</th>
                        <td>
                            <input type="checkbox" id="dict_more" value="1" style="vertical-align: middle;" /><label for="dict_more" style="vertical-align: middle;">是否允许多选</label></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                    <tr>
                        <th style="width: 100px;">宽度：</th>
                        <td>
                            <input type="text" id="files_width" class="mytext" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <th>文件类型：</th>
                        <td>
                            <div style="margin-top: 3px;">
                                <input type="text" id="files_filetype" class="mytext" style="width: 97%" /></div>
    ...
    $(function () {
        ...
        if (elehidden.size() > 0) {
            ...
            if (jsonstr.length > 0) {
                ...
                switch (editmode) {
                    case "text":
                        $("#text_defaultvalue").val(UtilDecodeUri(editjson.text_defaultvalue));
                        $("#text_valuetype").val(editjson.text_valuetype);
                        $("#text_maxlength").val(editjson.text_maxlength);
                        $("#text_width").val(editjson.text_width);
                        break;
                    case "textarea":
                        $("#textarea_defaultvalue").val(UtilDecodeUri(editjson.textarea_defaultvalue));
                    ...
                    case "radio":
                        ...
                        break;
                    case "datetime":
                        $("#datetime_defaultvalue").val(UtilDecodeUri(editjson.datetime_defaultvalue));
                        ...
                        break;
                    case "org":
                        $("#org_defaultvalue").val(UtilDecodeUri(editjson.org_defaultvalue));
