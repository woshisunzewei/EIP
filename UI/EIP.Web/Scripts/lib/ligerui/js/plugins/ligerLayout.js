    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function () {
            ...
            if ($("> div[position=left]", g.layout).length > 0) {
                ...
                g.left.header = $('<div class="l-layout-header l-accordion-header-hasicon"><div class="l-layout-header-toggle"></div><div class="l-layout-header-inner"></div></div>');
                ...
                //set reload
                if (g.left.content.attr("reload")) {
                    $(".l-layout-header-inner", g.left.header).after('<i><img src="/Contents/images/icons/reload.png" id="reload-menu" title="点击重新加载菜单信息"></i>');
                }
